...
func _initialize() -> void:
	...
	_check_eq(CareRules.exp_to_next_level(5), 5, "Lv 5 masih butuh 5 EXP")
	_check_eq(CareRules.exp_to_next_level(6), 10, "Lv 6 mulai butuh 10 EXP")
	_check_eq(CareRules.exp_to_next_level(39), 40, "Lv 39 butuh 40 EXP")
	_check_eq(CareRules.exp_to_next_level(40), 0, "Lv 40 tidak punya Level berikutnya")
	_check_eq(CareRules.exp_for_level(16), 150, "Adult dimulai pada 150 EXP")
	_check_eq(CareRules.exp_for_level(36), 700, "Evolved dimulai pada 700 EXP")
	_check_eq(CareRules.exp_for_level(40), CareRules.EXP_MAX, "Lv 40 dimulai pada 860 EXP")
	_check_eq(CareRules.level_from_exp(149), 15, "149 EXP masih Lv 15")
	_check_eq(CareRules.level_from_exp(150), 16, "150 EXP adalah Lv 16")
	_check_eq(CareRules.level_from_exp(699), 35, "699 EXP masih Lv 35")
	_check_eq(CareRules.level_from_exp(700), 36, "700 EXP adalah Lv 36")
	_check_eq(CareRules.level_from_exp(859), 39, "859 EXP masih Lv 39")
	_check_eq(CareRules.level_from_exp(860), 40, "860 EXP adalah Lv 40")
	_check_eq(CareRules.level_from_exp(999), 40, "Level di-cap 40")
	_check_eq(CareRules.exp_into_level(150), 0, "Adult mulai dari progress bar kosong")
	_check_eq(CareRules.exp_progress(860), 100.0, "Lv 40 menampilkan progress penuh")
	...
	_check_eq(CareRules.leveled_up(149, 190), 18, "lompatan beberapa Level merayakan Level akhir sekali")
	_check_eq(CareRules.leveled_up(850, 860), 40, "860 EXP menyeberang ke Level cap")
	_check_eq(CareRules.leveled_up(860, 900), 0, "EXP di atas cap bukan naik level")
