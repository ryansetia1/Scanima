...
- Dominant outfit geometry: one short flared field dress over leggings, with a
  wide utility belt sitting high at the waist, and short laced boots
- Intentional asymmetry: one sleeve is long to the wrist while the other is bare
  to the shoulder
- Theme motifs (max two): one round lens medallion at the belt, one slim scanner
  band on the bare arm
- Palette: magenta dress, deep plum hard shadow, cream trim, one gold accent on
  the medallion
