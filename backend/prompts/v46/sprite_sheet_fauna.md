...
The shallow camera must not make a grounded quadruped or other multi-leg animal
look balanced on one foreground paw or leg alone. When this body plan has four
or more distinct weight-bearing supports, at least two clearly separated
supports must read as the lowest ground contact in one shared narrow band. No
single support may be the only lowest point while the others hang visibly above
it. Preserve natural perspective: supports may sit at slightly different
depths, never force every foot onto one identical pixel row. Skip this rule for
bipeds, broad stable bases, serpentine bodies, intentionally hovering or flying
