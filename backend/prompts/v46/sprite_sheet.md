...
Keep the same camera: forward-left three-quarter view from a shallow angle
slightly above. Full body visible in every character cell at comparable scale.

GROUND CONTACT — MULTI-SUPPORT BODIES ONLY
The shallow camera must not make a grounded multi-support body look balanced on
one foreground wheel, paw, or leg alone. When this body plan has four or more
distinct weight-bearing supports, at least two clearly separated supports must
read as the lowest ground contact in one shared narrow band. No single support
may be the only lowest point while the others hang visibly above it. Preserve
natural perspective: supports may sit at slightly different depths, never force
every foot onto one identical pixel row. Skip this rule for bipeds, broad stable
bases, pots or rooted forms, serpentine bodies, intentionally hovering or flying
creatures, and one-legged bodies.
