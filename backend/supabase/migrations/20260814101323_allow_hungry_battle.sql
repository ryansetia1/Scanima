-- Hunger is a care pose, not a Battle lock. Bits come from wins; food costs
-- Bits. Gating start_battle on Hunger < 40 made 0 Bits + empty bag a dead end.
-- Energy stays: Sleep recovers it for free.
