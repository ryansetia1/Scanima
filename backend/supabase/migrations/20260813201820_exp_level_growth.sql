-- Care Score yang terlihat pemain menjadi EXP. Bond tidak lagi meter progres:
-- Play tidak ditolak BOND_FULL, JSON menulis bond 0, bonus terawat cukup tiga
-- kebutuhan, dan Dormant tidak mereset EXP (itu un-level).
