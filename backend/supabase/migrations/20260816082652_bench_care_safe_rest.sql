-- Floor bangku menahan decay, tidak mengangkat meter yang sudah di bawah
-- ambang. Bonus terawat dan pemulihan Dormant hanya untuk companion aktif;
-- Summon menandai Anima itu aktif sebelum recovery dicek.
...
begin
  ...
  if v_benched then
    -- Hold at the floor only when already at/above it. Never raise neglect.
