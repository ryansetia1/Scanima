...
# Godot: 121 pemeriksaan shell, theme, touch, care, inkubator, reduced motion
/Applications/Godot.app/Contents/MacOS/Godot --headless --path game \
...
│       ├── test_scan_ui.gd           # 121 kontrak shell + touch + motion
