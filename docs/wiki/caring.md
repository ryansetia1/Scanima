...
| **Energy** | Stamina | Habis dalam ~14 jam kalau bangun | **Sleep** |
| **Hygiene** | Kebersihan | Habis dalam ~24 jam | **Clean** |

Feed dan Clean masing-masing **5 Bits**. Play dan Sleep gratis.

## Feed

Mengisi Hunger **+35**. Tidak bisa dipakai kalau meter Hunger sudah kelihatan penuh — tombol redup, Bits tidak terpotong.

EXP +3 hanya kalau Anima **benar-benar lapar** (Hunger di bawah 40). Memberi makan yang sudah kenyang cuma buang Bits.

Satu Feed biasanya cukup untuk membuka gerbang Battle lagi.
...
Ia **tidak hilang** dan **EXP-nya tidak direset**. Feed dan Clean sampai kedua meter mencapai 50, ia pulih.

## Pose di Home

Anima menunjukkan keadaannya sendiri: lapar, kotor, tidur, atau lemah saat Dormant. Itu petunjuk, bukan hukuman tersembunyi.
