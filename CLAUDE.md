...
godot --headless --path game --script res://tests/test_scan_ui.gd       # 346 check shell + Battle + komponen + tap + touch + reduced motion
godot --headless --path game --script res://tests/test_i18n.gd          # 1332 check katalog + key + formatter + wrapping
