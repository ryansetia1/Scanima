...
godot --headless --path game --script res://tests/test_expedition_route_map.gd # 89 check route tree + preview/Enter Node + Skip Shop + prediksi turn/Switch/penutup Boss + preload art run
