...
godot --headless --path game --script res://tests/test_scan_ui.gd       # 419 check shell + Battle + komponen + tap + touch + reduced motion
godot --headless --path game --script res://tests/test_i18n.gd          # 1486 check katalog + key + formatter + wrapping
godot --headless --path game --script res://tests/test_game_rules.gd    # 61 check care + EXP/Level + kontrak event Battle
