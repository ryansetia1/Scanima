...
godot --headless --path game --script res://tests/test_scan_ui.gd       # 1554 check shell + Battle + Shop + Bag + komponen + tap + touch + press/release roster sungguhan + UI/SFX hooks + prediksi turn/care/Summon + rollback + cache boot + Trophy Showcase/evolution/Atlas + dialog Evolve gagal + preflight nama + Seeker Avatar arena + LoadingScreen
