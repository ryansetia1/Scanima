...
godot --headless --path game --script res://tests/test_scan_ui.gd       # 883 check shell + Battle + Shop + Bag + komponen + tap + touch + UI/SFX hooks + prediksi turn/care/Summon + rollback + cache boot + Trophy Showcase/evolution/Atlas + preflight nama
godot --headless --path game --script res://tests/test_i18n.gd          # 4267 check katalog + key + formatter + wrapping
