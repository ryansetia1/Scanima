...
- **Profil Anima** memakai dua kartu `HudSurface` yang sama (About + Combat): Traits grid 2 kolom, stats grid 5 kolom seperti Collection, satu help 96px per section, portrait 132px.
